<x-app-layout>
    <x-slot name="title">Orders | View</x-slot>
    ...
    <div class="card mb-4">
        <div class="card-header px-2">
            <div class="d-flex justify-content-start align-items-center">
                <h4 class="ms-2">Order Information</h4>
            </div>
        </div>
        ...
        <div class="card-body p-0">
            <x-changeOrderStatus :quantityOrdered="$order->quantity" :quantitySupplied="$deliveries->pluck('quantity')->sum()" :currentStatus="$order->status" :orderId="$order->id" />

            <div class="accordion m-0" id="accordionExample">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button text-dark p-2" type="button" data-bs-toggle="collapse"
                            data-bs-target="#orderDetails" aria-expanded="true" aria-controls="orderDetails">
                            <h5>Order Details</h5>
                        </button>
                    </h2>
                    @if ($errors->any())
                        <div id="orderDetails" class="accordion-collapse collapse p-0" aria-labelledby="headingOne"
                        ...
                        @else
                            <div id="orderDetails" class="accordion-collapse collapse show p-0"
                    ...
                    <div class="accordion-body p-2">
                        <div class="row">
                            ...
                            <div class="col-12 mb-1 ">
                                <strong>No:</strong>
                                <a class="text-dark" href="{{ route('order.waybillNo', [$order->waybill_no]) }}">
                                    {{ $order->waybill_no }}</a>
                            </div>
                            <div class="col-12 mb-1">
                                <strong class="">Issued on:</strong>
                                {{ date('d-M-Y', strtotime($order->date_issued)) }}
                            </div>
                            ...
                            <div class="col-12 mb-1"><strong>Issued By:</strong>
                                <a class="text-dark"
                                    href="{{ route('order.issuedBy', [$order->issued_by]) }}">{{ $order->issuedBy->name }}</a>
                            </div>
                            <div class="col-12 mb-1">
                            ...
                            <div class="col-12 mb-1">
                                ...
                                {{ $order->deadline != '' ? date('d-M-Y', strtotime($order->deadline)) : 'not specified' }}
                            </div>
                        </div>
                        <div class="row mt-1">
                            <div class="d-flex justify-content-end">
                                ...
                                <a class="btn btn-small btn-success py-1 mx-1"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form method="post" action="{{ route('order.delete') }}">
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    <button type="button" class="mx-1 btn btn-outline-success"
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed text-dark p-2" type="button" data-bs-toggle="collapse"
                        data-bs-target="#deliveryDetails" aria-expanded="false" aria-controls="deliveryDetails">
                        <h5>Delivery Details</h5>
                    </button>
                </h2>

                @if ($errors->any())
                    <div id="deliveryDetails" class="accordion-collapse collapse show p-0" aria-labelledby="headingTwo"
                        data-bs-parent="#accordionExample">
                    @else
                        <div id="deliveryDetails" class="accordion-collapse collapse p-0" aria-labelledby="headingTwo"
                            data-bs-parent="#accordionExample">
                @endif
                    ...
                    <div class="row">
                        <div class="col-12 d-flex align-items-center justify-content-between">
                            <div class="ms-0">
                                ...
                                {{ $deliveries->pluck('quantity')->sum() . ' ' . strtolower($order->value) }}
                            </div>

                            <!-- Add delivery button -->
                            <button type="button" class="small btn btn-sm btn-success" data-bs-toggle="modal"
                                data-bs-target="#addDelivery">Add</button>

                            <!-- Add delivery modal -->
                            <div class="modal fade" id="addDelivery" tabindex="-1"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-6 col-lg-1 input-group">
                                                        ...
                                                        <select class="form-select" name="value" required>
                                                            ...
                                                            <option value="pcs"
                                                                {{ old('value') == 'pcs' ? 'selected' : '' }}>pcs
                                                            </option>
                                                            <option value="sets"
                                                                {{ old('value') == 'sets' ? 'selected' : '' }}>sets
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <!-- Date delivered -->
                                                    <div class="mb-3 col-6 col-lg-1 input-group">
                                                        <span class="input-group-text"><strong>Delivered
                                                                on</strong></span>
                                                        <input type="date" name="date_delivered"
                                                            value="{{ old('date_delivered') != '' ? old('date_delivered') : date('Y-m-d') }}"
                                                            required />
                                                    </div>
                                                </div>
                                                <div class="d-flex justify-content-end">
                        ...
                        @if ($deliveries && $deliveries->count() > 0)
                            @foreach ($deliveries as $delivery)
                                ...
                                <div class="col-12 d-flex justify-content-between">
                                    <div class="small">
                                        {{ $delivery->quantity . ' ' . $delivery->value . ' delivered on ' . date('l', strtotime($delivery->date_delivered)) }}<br />
                                        <a
                                            href="{{ route('deliveries.date', [
                                    ...
                                    <div class="">
                                        ...
                                        <button type="button" class="small btn btn-sm btn-outline-danger"
                                            data-bs-toggle="modal"
                                            data-bs-target="#deleteDelivery{{ $delivery->id }}">Delete</button>

                                        <!-- Delete delivery modal -->
                                        <div class="modal fade" id="deleteDelivery{{ $delivery->id }}"
                                            tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Delete delivery
                                                        </h5>
                                                        <button type="button" class="btn-close"
                                                            data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <p>Before you continue, know that this action cannot be undone.
                                                        </p>
                                                        <p>Are you still sure you want to delete this delivery?</p>
                                                        <form method="post"
                                                            action="{{ route('deliveries.delete') }}">
                                                            @csrf
                                                            @method('delete')
